 ...
 *
 * `lib/converter/useConverter.ts` validates every file a conversion page is handed
 ...
 * check, kept separate from `lib/converter/formats.ts` because it has no matrix to
