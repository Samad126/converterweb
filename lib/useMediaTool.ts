 ...
 * `lib/usePdfFileTool.ts`'s async cousin.
 *
 ...
 * means `components/PdfToolShell.tsx` renders it with no changes at all —
...
import { downloadMediaJob, fetchMediaJobStatus, startMediaJob, MEDIA_POLL_INTERVAL_MS } from "./mediaApi";
...
import type { PdfFileTool, PdfToolPhase } from "./usePdfFileTool";
import type { PdfPart } from "./pdfApi";
