 ...
 * `lib/content/catalog.ts`, generated rather than hand-written.
 *
 ...
 * enumerable set of URLs, exactly as `lib/content/catalog.ts` does for documents.
 */
...
/** Re-exported so pages don't need to reach into `lib/media/mediaFormats` directly. */
