 ...
 * discovery endpoint for it. `lib/converter/formats.ts`'s ban on hard-coded extensions
 ...
 * `lib/content/catalog.ts` — a table that has to be written down somewhere because
